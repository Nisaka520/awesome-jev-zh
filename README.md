...
> 门槛是**纯 Star 数**（2026-09-20 UTC 快照，表里的徽章实时更新）。Star 多只说明被最多人看过、试过、吵过，不等于代码质量好或者能直接上生产——这里面大半是 Jev 发布一周内写出来的。表格按星数降序，所以第二行的 QuantDinger 是个规模完全不同的项目，看说明就明白了。每行都标了它所在的分区，想看同方向的其他项目往那儿翻。
...
<!-- HOT:START -->
> 🤖 由 [`scripts/collect_hot.py`](scripts/collect_hot.py) 每日自动抓取并排序，最后更新：**2026-09-21**（UTC）。收录规则：2026-09-10 之后创建、名称/描述/README 命中 Jev 生态关键词、Star ≥ 3，外加 [`typesafe-ai`](https://github.com/typesafe-ai) 官方组织全量。`🆕` = 本周新进榜，`▲` = 相比上次抓取的 Star 增量。

| # | 项目 | Star | 变化 | 语言 | 一句话 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | [**browser-use/jev-ultrafast**](https://github.com/browser-use/jev-ultrafast) `🆕` | ![](https://badgen.net/github/stars/browser-use/jev-ultrafast) | ▲ 3458 | Python | i. am. speed. |
| 2 | [**tamaratran/fast-jev-compaction**](https://github.com/tamaratran/fast-jev-compaction) `🆕` | ![](https://badgen.net/github/stars/tamaratran/fast-jev-compaction) | ▲ 943 | TS | Claude Code plugin that replaces the compaction summary with Jev decisions: every tool call and… |
| 3 | [**TheoLeeCJ/SemIf**](https://github.com/TheoLeeCJ/SemIf) `🆕` | ![](https://badgen.net/github/stars/TheoLeeCJ/SemIf) | ▲ 514 | Python | Semantic ifs from open models, on a 3090 at home. Independent; not affiliated with Jev or TypeS… |
| 4 | [**mizorewww/laya-mlx**](https://github.com/mizorewww/laya-mlx) `🆕` | ![](https://badgen.net/github/stars/mizorewww/laya-mlx) | — | Python | Native MLX runtime for Laya typed decision models — 7–14 ms short decisions on M3 Max. No text… |
| 5 | [**jarrodwatts/jev-trader**](https://github.com/jarrodwatts/jev-trader) `🆕` | ![](https://badgen.net/github/stars/jarrodwatts/jev-trader) | ▲ 263 | TS | One AI trade decision every Monad block. Jev on Kuru MON-USDC. |
| 6 | [**TianyuCodings/NanoJev**](https://github.com/TianyuCodings/NanoJev) `🆕` | ![](https://badgen.net/github/stars/TianyuCodings/NanoJev) | ▲ 524 | Python | A nano replica of Jev: parallel decisions, dynamic candidates, and an end-to-end training pipel… |
| 7 | [**typesafe-ai/skills**](https://github.com/typesafe-ai/skills) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/skills) | ▲ 504 | — | Agent skills for building with TypeSafe's System One API |
| 8 | [**vinnylarouge/jevlike**](https://github.com/vinnylarouge/jevlike) `🆕` | ![](https://badgen.net/github/stars/vinnylarouge/jevlike) | ▲ 99 | Python | — |
| 9 | [**jaredpalmer/kev**](https://github.com/jaredpalmer/kev) `🆕` | ![](https://badgen.net/github/stars/jaredpalmer/kev) | ▲ 511 | Python | tiny Jev-like family of decision models built on top of Qwen3.5 you can train and run on your o… |
| 10 | [**awlevin/typesafe-computer-use**](https://github.com/awlevin/typesafe-computer-use) `🆕` | ![](https://badgen.net/github/stars/awlevin/typesafe-computer-use) | ▲ 126 | Python | Computer use for about $0.0002 a step: OCR the screen, classify the next action with TypeSafe,… |
| 11 | [**yibie/awesome-jev**](https://github.com/yibie/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/yibie/awesome-jev) | ▲ 252 | Python | A curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's S… |
| 12 | [**githubnext/localjev**](https://github.com/githubnext/localjev) `🆕` | ![](https://badgen.net/github/stars/githubnext/localjev) | ▲ 192 | TS | — |
| 13 | [**v-modal/awesome-jev-tools**](https://github.com/v-modal/awesome-jev-tools) `🆕` | ![](https://badgen.net/github/stars/v-modal/awesome-jev-tools) | ▲ 355 | — | A curated list of tools built for Jev — TypeSafe AI's System One model for typed decisions. |
| 14 | [**Sac-Y/Jev-cu**](https://github.com/Sac-Y/Jev-cu) `🆕` | ![](https://badgen.net/github/stars/Sac-Y/Jev-cu) | ▲ 186 | JS | — |
| 15 | [**thruwire/foreman**](https://github.com/thruwire/foreman) `🆕` | ![](https://badgen.net/github/stars/thruwire/foreman) | ▲ 53 | Python | Software factory foreman based on TypeSafe's Jev model |
| 16 | [**devagrawal09/jev-review**](https://github.com/devagrawal09/jev-review) `🆕` | ![](https://badgen.net/github/stars/devagrawal09/jev-review) | ▲ 61 | TS | A staged code-review workflow and local dashboard built with TypeSafe Jev. |
| 17 | [**AbdelStark/awesome-typesafe**](https://github.com/AbdelStark/awesome-typesafe) `🆕` | ![](https://badgen.net/github/stars/AbdelStark/awesome-typesafe) | ▲ 52 | CSS | A curated list of official resources and community projects for TypeSafe, System One models, an… |
| 18 | [**featherless-ai/simple-jev**](https://github.com/featherless-ai/simple-jev) `🆕` | ![](https://badgen.net/github/stars/featherless-ai/simple-jev) | ▲ 104 | Python | Turn any open model into a classifier/jev endpoint |
| 19 | [**dabit3/jev-experiments**](https://github.com/dabit3/jev-experiments) `🆕` | ![](https://badgen.net/github/stars/dabit3/jev-experiments) | ▲ 34 | TS | — |
| 20 | [**superagents-lab/jev-search**](https://github.com/superagents-lab/jev-search) `🆕` | ![](https://badgen.net/github/stars/superagents-lab/jev-search) | ▲ 76 | TS | Search the web with TypeSafe's Jev: source selection, query understanding and relevance ranking… |
| 21 | [**kyotofin/tax-doc-classifier**](https://github.com/kyotofin/tax-doc-classifier) `🆕` | ![](https://badgen.net/github/stars/kyotofin/tax-doc-classifier) | ▲ 38 | TS | Tax document page classifier built on Jev decisions. 100% strict accuracy across 261 IRS forms,… |
| 22 | [**fhshaik/typesafe-mario**](https://github.com/fhshaik/typesafe-mario) `🆕` | ![](https://badgen.net/github/stars/fhshaik/typesafe-mario) | ▲ 15 | Python | A TypeSafe/Jev agent that plays Super Mario Bros. from structured emulator state. |
| 23 | [**rmalde/minecraft-agent**](https://github.com/rmalde/minecraft-agent) `🆕` | ![](https://badgen.net/github/stars/rmalde/minecraft-agent) | — | JS | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run v… |
| 24 | [**droidrun/mobile-jev**](https://github.com/droidrun/mobile-jev) `🆕` | ![](https://badgen.net/github/stars/droidrun/mobile-jev) | ▲ 54 | JS | — |
| 25 | [**kerpopule/hermes-jev-skills**](https://github.com/kerpopule/hermes-jev-skills) `🆕` | ![](https://badgen.net/github/stars/kerpopule/hermes-jev-skills) | ▲ 221 | Python | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for He… |
| 26 | [**cobanov/awesome-jev**](https://github.com/cobanov/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/cobanov/awesome-jev) | ▲ 65 | — | A curated, source-backed list of projects built with Jev, TypeSafe AI's System One model for ty… |
| 27 | [**gargpratyush/jev-router**](https://github.com/gargpratyush/jev-router) `🆕` | ![](https://badgen.net/github/stars/gargpratyush/jev-router) | ▲ 51 | JS | Route to the cheapest model in claude code for your task using jev-router |
| 28 | [**wy-coliney/jev-browser-use**](https://github.com/wy-coliney/jev-browser-use) `🆕` | ![](https://badgen.net/github/stars/wy-coliney/jev-browser-use) | ▲ 68 | JS | 5–10x faster browser operations: Jev clicks, Codex thinks and verifies. Built at EZCollegeApp. |
| 29 | [**realZachi/pg-jev**](https://github.com/realZachi/pg-jev) `🆕` | ![](https://badgen.net/github/stars/realZachi/pg-jev) | ▲ 34 | Shell | Ask your Postgres tables questions in plain language. A PostgreSQL extension powered by TypeSaf… |
| 30 | [**sutro-sh/jev-align**](https://github.com/sutro-sh/jev-align) `🆕` | ![](https://badgen.net/github/stars/sutro-sh/jev-align) | ▲ 114 | Python | Build calibrated AI Functions from human feedback using Jev and GEPA. |
| 31 | [**ekzhang/openjev-sglang**](https://github.com/ekzhang/openjev-sglang) `🆕` | ![](https://badgen.net/github/stars/ekzhang/openjev-sglang) | ▲ 32 | Python | Jev-compatible API endpoint based on open models (prefill-only) |
| 32 | [**logicrw/awesome-jev-projects**](https://github.com/logicrw/awesome-jev-projects) `🆕` | ![](https://badgen.net/github/stars/logicrw/awesome-jev-projects) | ▲ 103 | JS | Awesome Jev: source-backed open-source ecosystem radar, plain-language project discovery, and a… |
| 33 | [**kitze/skillbox**](https://github.com/kitze/skillbox) `🆕` | ![](https://badgen.net/github/stars/kitze/skillbox) | ▲ 20 | TS | Self-hosted, versioned skills library for AI agents. MCP, scoped clients, and optional Jev reco… |
| 34 | [**wfzyx/von**](https://github.com/wfzyx/von) `🆕` | ![](https://badgen.net/github/stars/wfzyx/von) | ▲ 168 | Python | The open-source System One decision model. Sub-15ms, non-autoregressive, local drop-in alternat… |
| 35 | [**razorback16/openjev**](https://github.com/razorback16/openjev) `🆕` | ![](https://badgen.net/github/stars/razorback16/openjev) | ▲ 77 | Python | Open, Jev-compatible System One decision server on DiffusionGemma |
| 36 | [**typesafe-ai/system-one-adapter-python**](https://github.com/typesafe-ai/system-one-adapter-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/system-one-adapter-python) | ▲ 34 | Python | Drop-in TypeSafeClient replacement backed by LLM APIs |
| 37 | [**NiazMorshed2007/jev-review**](https://github.com/NiazMorshed2007/jev-review) `🆕` | ![](https://badgen.net/github/stars/NiazMorshed2007/jev-review) | ▲ 21 | TS | Local-first MCP plugin for continuous software-quality review by AI coding agents, powered by J… |
| 38 | [**typesafe-ai/typesafe-sdk-js**](https://github.com/typesafe-ai/typesafe-sdk-js) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-js) | ▲ 19 | TS | The official TypeScript/JavaScript library for the TypeSafe API |
| 39 | [**jkudish/jev-browser**](https://github.com/jkudish/jev-browser) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-browser) | ▲ 39 | TS | Browser use using Typesafe's Jev model |
| 40 | [**Heman10x-NGU/openJev-verdict-2.0**](https://github.com/Heman10x-NGU/openJev-verdict-2.0) `🆕` | ![](https://badgen.net/github/stars/Heman10x-NGU/openJev-verdict-2.0) | ▲ 147 | Python | Calibrated 151M Non-Autoregressive Decision Engine beating TypeSafe Jev & Laya on LocalLLaMA/ty… |
| 41 | [**fatwang2/awesome-jev**](https://github.com/fatwang2/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/fatwang2/awesome-jev) | ▲ 20 | JS | A source-backed Jev project directory with a reusable Jev-only GitHub review workflow. |
| 42 | [**hr98w/jev-visual**](https://github.com/hr98w/jev-visual) `🆕` | ![](https://badgen.net/github/stars/hr98w/jev-visual) | ▲ 25 | Python | An educational Jev-like visual inference experiment on Apple Silicon: shared context, direct ca… |
| 43 | [**logan-markewich/jeff**](https://github.com/logan-markewich/jeff) `🆕` | ![](https://badgen.net/github/stars/logan-markewich/jeff) | ▲ 58 | Python | A self-hosted drop-in replacement for TypeSafe's jev, powered by GliFormer. |
| 44 | [**moritzkremb/jev-voice-browser**](https://github.com/moritzkremb/jev-voice-browser) `🆕` | ![](https://badgen.net/github/stars/moritzkremb/jev-voice-browser) | ▲ 44 | JS | Control a real browser by voice. Jev (TypeSafe System One) decides intent + target in ~300 ms p… |
| 45 | [**lakeday-org/perch**](https://github.com/lakeday-org/perch) `🆕` | ![](https://badgen.net/github/stars/lakeday-org/perch) | ▲ 6 | JS | Semantic code linting with Jev |
| 46 | [**jkudish/jev-mcp**](https://github.com/jkudish/jev-mcp) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-mcp) | ▲ 56 | TS | Fast, cheap, typed judgments from TypeSafe's Jev model, as MCP tools. |
| 47 | [**Mapika/decider**](https://github.com/Mapika/decider) `🆕` | ![](https://badgen.net/github/stars/Mapika/decider) | ▲ 66 | Python | One-pass typed decisions with calibrated probabilities (System One style model), fine-tuned fro… |
| 48 | [**wuyoscar/jev-skill**](https://github.com/wuyoscar/jev-skill) `🆕` | ![](https://badgen.net/github/stars/wuyoscar/jev-skill) | — | Python | An awesome collection of Jev use cases, workflows, and agent skills. |
| 49 | [**typesafe-ai/typesafe-sdk-python**](https://github.com/typesafe-ai/typesafe-sdk-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-python) | ▲ 29 | Python | The official Python library for the TypeSafe API |
| 50 | [**kunchenguid/compact-adviser**](https://github.com/kunchenguid/compact-adviser) `🆕` | ![](https://badgen.net/github/stars/kunchenguid/compact-adviser) | ▲ 14 | TS | "Work appears completed or recorded. Run /compact to save tokens." |
| 51 | [**kitze/unclutter**](https://github.com/kitze/unclutter) `🆕` | ![](https://badgen.net/github/stars/kitze/unclutter) | ▲ 10 | TS | WXT browser extension: Jev-powered page clutter removal with reusable template rules. |
| 52 | [**itsmostafa/typesafe-mcp**](https://github.com/itsmostafa/typesafe-mcp) `🆕` | ![](https://badgen.net/github/stars/itsmostafa/typesafe-mcp) | ▲ 28 | Go | mcp connector to give your AI agent direct access to typesafe ai's jev model |
| 53 | [**brainstormity/Jev-X-Sentiment-Analysis**](https://github.com/brainstormity/Jev-X-Sentiment-Analysis) `🆕` | ![](https://badgen.net/github/stars/brainstormity/Jev-X-Sentiment-Analysis) | ▲ 124 | Python | — |
| 54 | [**mmastrac/djev-spark**](https://github.com/mmastrac/djev-spark) `🆕` | ![](https://badgen.net/github/stars/mmastrac/djev-spark) | ▲ 47 | HTML | DiffusionGemma NVFP4 structured decisions on a DGX Spark: container recipe |
| 55 | [**tamaratran/jev-pruner**](https://github.com/tamaratran/jev-pruner) `🆕` | ![](https://badgen.net/github/stars/tamaratran/jev-pruner) | ▲ 13 | TS | Claude Code plugin: trim long Bash output with TypeSafe Jev before the model sees it |
| 56 | [**AnotiaWang/awesome-jev**](https://github.com/AnotiaWang/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/AnotiaWang/awesome-jev) | ▲ 44 | — | A curated list of awesome Jev / TypeSafe System One applications, libraries, and resources. |
| 57 | [**dbreunig/building-with-jev-skill**](https://github.com/dbreunig/building-with-jev-skill) `🆕` | ![](https://badgen.net/github/stars/dbreunig/building-with-jev-skill) | ▲ 10 | — | A skill for writing and improving programs that call Jev, TypeSafe's System One model |
| 58 | [**standardagents/jevpilot**](https://github.com/standardagents/jevpilot) `🆕` | ![](https://badgen.net/github/stars/standardagents/jevpilot) | ▲ 24 | JS | A playable Three.js driving simulator with Jev-powered autopilot |
| 59 | [**y0usaf/pi-jev**](https://github.com/y0usaf/pi-jev) `🆕` | ![](https://badgen.net/github/stars/y0usaf/pi-jev) | ▲ 42 | TS | TypeSafe Jev as a decision layer for the Pi coding agent: a measured tool-call gate plus jev_as… |
| 60 | [**uehaj/jev-semgrep**](https://github.com/uehaj/jev-semgrep) `🆕` | ![](https://badgen.net/github/stars/uehaj/jev-semgrep) | ▲ 36 | JS | grep by meaning, across languages. TypeSafe Jev scores every line against a meaning; combine me… |
<!-- HOT:END -->
