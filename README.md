...
<!-- HOT:START -->
> 🤖 由 [`scripts/collect_hot.py`](scripts/collect_hot.py) 每日自动抓取并排序，最后更新：**2026-09-22**（UTC）。收录规则：2026-09-10 之后创建、名称/描述/README 命中 Jev 生态关键词、Star ≥ 3，外加 [`typesafe-ai`](https://github.com/typesafe-ai) 官方组织全量。`🆕` = 本周新进榜，`▲` = 相比上次抓取的 Star 增量。

| # | 项目 | Star | 变化 | 语言 | 一句话 |
| :-- | :-- | :-- | :-- | :-- | :-- |
| 1 | [**browser-use/jev-ultrafast**](https://github.com/browser-use/jev-ultrafast) `🆕` | ![](https://badgen.net/github/stars/browser-use/jev-ultrafast) | ▲ 3821 | Python | Fastest and cheapest web agent |
| 2 | [**tamaratran/fast-jev-compaction**](https://github.com/tamaratran/fast-jev-compaction) `🆕` | ![](https://badgen.net/github/stars/tamaratran/fast-jev-compaction) | ▲ 773 | TS | Claude Code plugin that replaces the compaction summary with Jev decisions: every tool call and… |
| 3 | [**mizorewww/laya-mlx**](https://github.com/mizorewww/laya-mlx) `🆕` | ![](https://badgen.net/github/stars/mizorewww/laya-mlx) | ▲ 2153 | Python | Native MLX runtime for Laya typed decision models — 7–14 ms short decisions on M3 Max. No text… |
| 4 | [**TheoLeeCJ/SemIf**](https://github.com/TheoLeeCJ/SemIf) `🆕` | ![](https://badgen.net/github/stars/TheoLeeCJ/SemIf) | ▲ 803 | Python | Semantic ifs from open models, on a 3090 at home. Independent; not affiliated with Jev or TypeS… |
| 5 | [**jaredpalmer/kev**](https://github.com/jaredpalmer/kev) `🆕` | ![](https://badgen.net/github/stars/jaredpalmer/kev) | ▲ 1426 | Python | tiny Jev-like family of decision models built on top of Qwen3.5 you can train and run on your o… |
| 6 | [**jarrodwatts/jev-trader**](https://github.com/jarrodwatts/jev-trader) `🆕` | ![](https://badgen.net/github/stars/jarrodwatts/jev-trader) | ▲ 320 | TS | One AI trade decision every Monad block. Jev on Kuru MON-USDC. |
| 7 | [**TianyuCodings/NanoJev**](https://github.com/TianyuCodings/NanoJev) `🆕` | ![](https://badgen.net/github/stars/TianyuCodings/NanoJev) | ▲ 400 | Python | A nano replica of Jev: parallel decisions, dynamic candidates, and an end-to-end training pipel… |
| 8 | [**typesafe-ai/skills**](https://github.com/typesafe-ai/skills) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/skills) | ▲ 392 | — | Agent skills for building with TypeSafe's System One API |
| 9 | [**vinnylarouge/jevlike**](https://github.com/vinnylarouge/jevlike) `🆕` | ![](https://badgen.net/github/stars/vinnylarouge/jevlike) | ▲ 84 | Python | — |
| 10 | [**jev-chat/jev-chat-jarvis**](https://github.com/jev-chat/jev-chat-jarvis) `🆕` | ![](https://badgen.net/github/stars/jev-chat/jev-chat-jarvis) | — | Kotlin | 装在手机上的对话副驾：在微信 / QQ / X / 飞书里读懂对方、给出候选回复、一键填入输入框，发不发由你。非侵入，只读屏幕，不 hook 不改包。 |
| 11 | [**yibie/awesome-jev**](https://github.com/yibie/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/yibie/awesome-jev) | ▲ 363 | Python | A curated list of public projects, integrations, and discussions built on Jev — TypeSafe AI's S… |
| 12 | [**awlevin/typesafe-computer-use**](https://github.com/awlevin/typesafe-computer-use) `🆕` | ![](https://badgen.net/github/stars/awlevin/typesafe-computer-use) | ▲ 113 | Python | Computer use for about $0.0002 a step: OCR the screen, classify the next action with TypeSafe,… |
| 13 | [**githubnext/localjev**](https://github.com/githubnext/localjev) `🆕` | ![](https://badgen.net/github/stars/githubnext/localjev) | ▲ 85 | TS | — |
| 14 | [**v-modal/awesome-jev-tools**](https://github.com/v-modal/awesome-jev-tools) `🆕` | ![](https://badgen.net/github/stars/v-modal/awesome-jev-tools) | ▲ 75 | — | A curated list of tools built for Jev — TypeSafe AI's System One model for typed decisions. |
| 15 | [**Sac-Y/Jev-cu**](https://github.com/Sac-Y/Jev-cu) `🆕` | ![](https://badgen.net/github/stars/Sac-Y/Jev-cu) | ▲ 65 | JS | — |
| 16 | [**devagrawal09/jev-review**](https://github.com/devagrawal09/jev-review) `🆕` | ![](https://badgen.net/github/stars/devagrawal09/jev-review) | ▲ 75 | TS | A staged code-review workflow and local dashboard built with TypeSafe Jev. |
| 17 | [**rmalde/minecraft-agent**](https://github.com/rmalde/minecraft-agent) `🆕` | ![](https://badgen.net/github/stars/rmalde/minecraft-agent) | ▲ 178 | JS | Astra planner and JEV controller for Minecraft, with native recording, tested routes, and run v… |
| 18 | [**thruwire/foreman**](https://github.com/thruwire/foreman) `🆕` | ![](https://badgen.net/github/stars/thruwire/foreman) | ▲ 27 | Python | Software factory foreman based on TypeSafe's Jev model |
| 19 | [**featherless-ai/simple-jev**](https://github.com/featherless-ai/simple-jev) `🆕` | ![](https://badgen.net/github/stars/featherless-ai/simple-jev) | ▲ 57 | Python | Turn any open model into a classifier/jev endpoint |
| 20 | [**AbdelStark/awesome-typesafe-jev**](https://github.com/AbdelStark/awesome-typesafe-jev) `🆕` | ![](https://badgen.net/github/stars/AbdelStark/awesome-typesafe-jev) | — | HTML | Awesome Jev: a source-backed field guide to TypeSafe's System One model, with SDKs, live demos,… |
| 21 | [**kerpopule/hermes-jev-skills**](https://github.com/kerpopule/hermes-jev-skills) `🆕` | ![](https://badgen.net/github/stars/kerpopule/hermes-jev-skills) | ▲ 129 | Python | Jev-powered model routing, memory, compaction, skill selection, computer and browser use for He… |
| 22 | [**superagents-lab/jev-search**](https://github.com/superagents-lab/jev-search) `🆕` | ![](https://badgen.net/github/stars/superagents-lab/jev-search) | ▲ 71 | TS | Search the web with TypeSafe's Jev: source selection, query understanding and relevance ranking… |
| 23 | [**wuyoscar/jev-skill**](https://github.com/wuyoscar/jev-skill) `🆕` | ![](https://badgen.net/github/stars/wuyoscar/jev-skill) | ▲ 213 | Python | An awesome collection of Jev use cases, workflows, and agent skills. |
| 24 | [**wfzyx/von**](https://github.com/wfzyx/von) `🆕` | ![](https://badgen.net/github/stars/wfzyx/von) | ▲ 150 | Python | The open-source System One decision model. Sub-15ms, non-autoregressive, local drop-in alternat… |
| 25 | [**dabit3/jev-experiments**](https://github.com/dabit3/jev-experiments) `🆕` | ![](https://badgen.net/github/stars/dabit3/jev-experiments) | ▲ 17 | TS | — |
| 26 | [**kyotofin/tax-doc-classifier**](https://github.com/kyotofin/tax-doc-classifier) `🆕` | ![](https://badgen.net/github/stars/kyotofin/tax-doc-classifier) | ▲ 40 | TS | Tax document page classifier built on Jev decisions. 100% strict accuracy across 261 IRS forms,… |
| 27 | [**fhshaik/typesafe-mario**](https://github.com/fhshaik/typesafe-mario) `🆕` | ![](https://badgen.net/github/stars/fhshaik/typesafe-mario) | ▲ 35 | Python | A TypeSafe/Jev agent that plays Super Mario Bros. from structured emulator state. |
| 28 | [**droidrun/mobile-jev**](https://github.com/droidrun/mobile-jev) `🆕` | ![](https://badgen.net/github/stars/droidrun/mobile-jev) | ▲ 48 | JS | — |
| 29 | [**wy-coliney/jev-browser-use**](https://github.com/wy-coliney/jev-browser-use) `🆕` | ![](https://badgen.net/github/stars/wy-coliney/jev-browser-use) | ▲ 67 | JS | 5–10x faster browser operations: Jev clicks, Codex thinks and verifies. Built at EZCollegeApp. |
| 30 | [**logicrw/awesome-jev-projects**](https://github.com/logicrw/awesome-jev-projects) `🆕` | ![](https://badgen.net/github/stars/logicrw/awesome-jev-projects) | ▲ 96 | JS | Awesome Jev: source-backed open-source ecosystem radar, plain-language project discovery, and a… |
| 31 | [**gargpratyush/jev-router**](https://github.com/gargpratyush/jev-router) `🆕` | ![](https://badgen.net/github/stars/gargpratyush/jev-router) | ▲ 54 | JS | Route to the cheapest model in claude code for your task using jev-router |
| 32 | [**cobanov/awesome-jev**](https://github.com/cobanov/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/cobanov/awesome-jev) | ▲ 47 | — | A curated, source-backed list of projects built with Jev, TypeSafe AI's System One model for ty… |
| 33 | [**realZachi/pg-jev**](https://github.com/realZachi/pg-jev) `🆕` | ![](https://badgen.net/github/stars/realZachi/pg-jev) | ▲ 34 | Shell | Ask your Postgres tables questions in plain language. A PostgreSQL extension powered by TypeSaf… |
| 34 | [**razorback16/openjev**](https://github.com/razorback16/openjev) `🆕` | ![](https://badgen.net/github/stars/razorback16/openjev) | ▲ 74 | Python | Open, Jev-compatible System One decision server on DiffusionGemma |
| 35 | [**Mapika/decider**](https://github.com/Mapika/decider) `🆕` | ![](https://badgen.net/github/stars/Mapika/decider) | ▲ 116 | Python | A family of System One-style models fine-tuned from Qwen3.5, designed for one-pass typed decisi… |
| 36 | [**sutro-sh/jev-align**](https://github.com/sutro-sh/jev-align) `🆕` | ![](https://badgen.net/github/stars/sutro-sh/jev-align) | ▲ 29 | Python | Build calibrated AI Functions from human feedback using Jev and GEPA. |
| 37 | [**ekzhang/openjev-sglang**](https://github.com/ekzhang/openjev-sglang) `🆕` | ![](https://badgen.net/github/stars/ekzhang/openjev-sglang) | ▲ 28 | Python | Jev-compatible API endpoint based on open models (prefill-only) |
| 38 | [**AnotiaWang/awesome-jev**](https://github.com/AnotiaWang/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/AnotiaWang/awesome-jev) | ▲ 125 | — | A curated list of awesome Jev / TypeSafe System One applications, libraries, and resources. |
| 39 | [**typesafe-ai/system-one-adapter-python**](https://github.com/typesafe-ai/system-one-adapter-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/system-one-adapter-python) | ▲ 42 | Python | Drop-in TypeSafeClient replacement backed by LLM APIs |
| 40 | [**Heman10x-NGU/openJev-verdict-2.0**](https://github.com/Heman10x-NGU/openJev-verdict-2.0) `🆕` | ![](https://badgen.net/github/stars/Heman10x-NGU/openJev-verdict-2.0) | ▲ 57 | Python | Calibrated 151M Non-Autoregressive Decision Engine beating TypeSafe Jev & Laya on LocalLLaMA/ty… |
| 41 | [**jkudish/jev-mcp**](https://github.com/jkudish/jev-mcp) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-mcp) | ▲ 73 | JS | Fast, cheap, typed judgments from TypeSafe's Jev model, as MCP tools. |
| 42 | [**jkudish/jev-browser**](https://github.com/jkudish/jev-browser) `🆕` | ![](https://badgen.net/github/stars/jkudish/jev-browser) | ▲ 46 | TS | Browser use using Typesafe's Jev model |
| 43 | [**Rizzo-AI-Academy/rizzo-flow**](https://github.com/Rizzo-AI-Academy/rizzo-flow) `🆕` | ![](https://badgen.net/github/stars/Rizzo-AI-Academy/rizzo-flow) | — | Python | The open, local take on Jev: typed decisions from an LLM, without generating a single token |
| 44 | [**kitze/skillbox**](https://github.com/kitze/skillbox) `🆕` | ![](https://badgen.net/github/stars/kitze/skillbox) | ▲ 6 | TS | Self-hosted, versioned skills library for AI agents. MCP, scoped clients, and optional Jev reco… |
| 45 | [**itsmostafa/typesafe-mcp**](https://github.com/itsmostafa/typesafe-mcp) `🆕` | ![](https://badgen.net/github/stars/itsmostafa/typesafe-mcp) | ▲ 82 | Go | mcp connector to give your AI agent direct access to typesafe ai's jev model |
| 46 | [**hr98w/jev-visual**](https://github.com/hr98w/jev-visual) `🆕` | ![](https://badgen.net/github/stars/hr98w/jev-visual) | ▲ 47 | Python | An educational Jev-like visual inference experiment on Apple Silicon: shared context, direct ca… |
| 47 | [**typesafe-ai/typesafe-sdk-js**](https://github.com/typesafe-ai/typesafe-sdk-js) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-js) | ▲ 30 | TS | The official TypeScript/JavaScript library for the TypeSafe API |
| 48 | [**moritzkremb/jev-voice-browser**](https://github.com/moritzkremb/jev-voice-browser) `🆕` | ![](https://badgen.net/github/stars/moritzkremb/jev-voice-browser) | ▲ 41 | JS | Control a real browser by voice. Jev (TypeSafe System One) decides intent + target in ~300 ms p… |
| 49 | [**logan-markewich/jeff**](https://github.com/logan-markewich/jeff) `🆕` | ![](https://badgen.net/github/stars/logan-markewich/jeff) | ▲ 34 | Python | A self-hosted drop-in replacement for TypeSafe's jev, powered by GliFormer. |
| 50 | [**NiazMorshed2007/jev-review**](https://github.com/NiazMorshed2007/jev-review) `🆕` | ![](https://badgen.net/github/stars/NiazMorshed2007/jev-review) | ▲ 12 | TS | Local-first MCP plugin for continuous software-quality review by AI coding agents, powered by J… |
| 51 | [**jerryjliu/docjev**](https://github.com/jerryjliu/docjev) `🆕` | ![](https://badgen.net/github/stars/jerryjliu/docjev) | ▲ 125 | Python | A very fast document classifier/splitter using Jev |
| 52 | [**fatwang2/awesome-jev**](https://github.com/fatwang2/awesome-jev) `🆕` | ![](https://badgen.net/github/stars/fatwang2/awesome-jev) | ▲ 9 | JS | A source-backed Jev project directory with a reusable Jev-only GitHub review workflow. |
| 53 | [**typesafe-ai/typesafe-sdk-python**](https://github.com/typesafe-ai/typesafe-sdk-python) `官方` `🆕` | ![](https://badgen.net/github/stars/typesafe-ai/typesafe-sdk-python) | ▲ 36 | Python | The official Python library for the TypeSafe API |
| 54 | [**0xNatoshi/jev-codex-router**](https://github.com/0xNatoshi/jev-codex-router) `🆕` | ![](https://badgen.net/github/stars/0xNatoshi/jev-codex-router) | ▲ 86 | JS | Per-turn model & reasoning routing for Codex, driven by Jev (TypeSafe System One): picks the mo… |
| 55 | [**receptron/laya**](https://github.com/receptron/laya) `🆕` | ![](https://badgen.net/github/stars/receptron/laya) | ▲ 147 | TS | Run Laya, the open-source Jev-compatible System-1 decision model, from Node.js / TypeScript via… |
| 56 | [**kitze/unclutter**](https://github.com/kitze/unclutter) `🆕` | ![](https://badgen.net/github/stars/kitze/unclutter) | ▲ 26 | TS | WXT browser extension: Jev-powered page clutter removal with reusable template rules. |
| 57 | [**kunchenguid/compact-adviser**](https://github.com/kunchenguid/compact-adviser) `🆕` | ![](https://badgen.net/github/stars/kunchenguid/compact-adviser) | ▲ 22 | TS | "Work appears completed or recorded. Run /compact to save tokens." |
| 58 | [**lakeday-org/perch**](https://github.com/lakeday-org/perch) `🆕` | ![](https://badgen.net/github/stars/lakeday-org/perch) | ▲ 2 | JS | Semantic code linting with Jev |
| 59 | [**dealerdefi/Jevmind**](https://github.com/dealerdefi/Jevmind) `🆕` | ![](https://badgen.net/github/stars/dealerdefi/Jevmind) | — | Python | — |
| 60 | [**mmastrac/djev-spark**](https://github.com/mmastrac/djev-spark) `🆕` | ![](https://badgen.net/github/stars/mmastrac/djev-spark) | ▲ 30 | HTML | DiffusionGemma NVFP4 structured decisions on a DGX Spark: container recipe |
<!-- HOT:END -->
